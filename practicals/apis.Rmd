...
So, let's try to access these data programmatially. We are going to use the function
`fromJSON()` from the `jsonlite` package. Please check the syntax of this function
as well as the other function of this package.
...
If this is to easy for you, why don't you check the new [Quatro format](https://quarto.org/docs/guide/).
```
